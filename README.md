...
Допустим, что пиковое потребление выше суточной в 2 раза, тогда пиковая нагрузка - около 2024 ГБит/c.
...
| Photos | 105 Гб |
 ...
 #### Индексы
  ...
  |-------|--------|------------|
  | Sessions | session_token | необходимо для всех запросов пользователя, кроме запросов для профиля (поле телефон)|
