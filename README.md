...
| --- | --- | --- | --- |-----|-----|
| Users | 48 Гб | 2 | 3585 | шарды по диапазонам user_id| master-slave репликация - по 2 реплики на сервер|
| Swipes | 128 Гб | 3470 | 3240 | шарды по диапазонам user_id (в таблице встречные строки)| master-slave репликация - по 2 реплики на сервер|
| Sessions | 7 Гб | 2 | 8300 ||
| Messages | 7.5 Тб | 2300 | 2300 | шарды по диапазонам match_id| master-slave репликация - по 2 реплики на сервер|
| Matches | 45 Гб | 115 | 115 | шарды по диапазонам first_user_id (в таблице встречные строки)| master-slave репликация - по 2 реплики на сервер|
| Photos | 140 Гб | 2 | 3585 | шарды по диапазонам user_id|master-slave репликация - по 2 реплики на сервер |
