...
| Swipes | 128 Гб | 3470 | 3240 | горизонтальное шардирование, шарды по диапазонам  user_id (range)| master-slave репликация - по 2 реплики на сервер|
...
| Matches | 45 Гб | 115 | 115 | горизонтальное шардирование, шарды по диапазонам  user_id(range) | master-slave репликация - по 2 реплики на сервер|
