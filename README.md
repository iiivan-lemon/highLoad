...
| Таблица | Общий размер | RPS ( insert + select) |
| --- | --- | --- |
| Users | 48 Гб | 3587 ( 3585 + 2 )|
| Swipes | 68 Гб | 3585 (3470 + 115) |
| Sessions | 7 Гб | 8302 ( 2 + 8300 )|
| Messages | 5.5 Тб | 4600 ( 2300 + 2300 ) |
| Matches | 17 Гб | 230 ( 115 + 115 ) |
| Photos | 105 Гб | 3587 ( 3585 + 2 )|
...
`select RPS  = 18520 + 115 = 18635 RPS ( отображение профиля при свайпе, при мэтче)`
...
за день имеем 300 млн. свайпов
предположим, что хранить данные о свайпах будем 7 дней\
`Общий размер: 35 * 7 * 300 * 10^6 = 68 Гб`\
