...
Дисковое пространство, требуемое для кэширования фотографий:\
  `В расчете на 75 млн. пользователей, средний размер хранилища фото пользователя 10Мб , желаем получить cache hit 60%, тогда объем кэша 100 * 10^6 * 4 * 4 * 0,6 Мб =  430 Тб`
  |Узел            |Cores  | RAM  | Количество (репликация)  | 
|-------------- |----- |-----|------------|
| Фронтэнд     | 32    | 128  | 9 (3 мастера, 6 слейвов)| 
| Авторизация  | 32    | 128  | 9 (3 мастера, 6 слейвов)|      
| Пользователь | 16    | 64   | 9 (3 мастера, 6 слейвов)|
| Сообщения       | 16    | 64   | 9 (3 мастера, 6 слейвов)|
| Свайпы | 32     | 64   | 12 (4 мастера, 8 слейвов)  
| БД (PostgreSQL + Redis) | 32    | 64   | 36 (12 мастеров, 24 слейва)| 
| Прокси фотографий | 36   | 128  | 30 (по 12 ТБ SSD)|
#### Источники
