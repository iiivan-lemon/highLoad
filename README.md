...
#### Схема шардинга
Записи в Users, Swipes, Photos будут принадлежать конкретному шарду, если конкректный id пользователя соответствующей записи принадлежит диапозону user_id данного шарда.
